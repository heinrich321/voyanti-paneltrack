...
class PaneltrackClient:
    register_map = {
        ...
        "MonthkWhTotal": {"start_address": 53, "length": 2, "type": "FLOAT32", "state_class": "total_increasing", "device_class": "energy", "unit": "kWh"},
        "DaykWhTotal": {"start_address": 55, "length": 2, "type": "FLOAT32", "state_class": "total_increasing", "device_class": "energy", "unit": "kWh"},
